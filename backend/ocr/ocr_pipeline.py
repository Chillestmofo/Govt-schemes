...
def get_reader():
    ...
    if _reader is None:
        ...
        # Use GPU only if CUDA is available. EasyOCR has known bugs with MPS (Apple Silicon) that cause gibberish output.
...
def preprocess_image(image: Image.Image) -> Image.Image:
    ...
    # If image is too large, downscale it to prevent EasyOCR from hallucinating and taking forever
    if width > 1500:
        ratio = 1500 / width
